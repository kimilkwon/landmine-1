...
<body class="home_body">
	...
	<div class="content">
		<div class="banner">
		  <div class="banner_box">
			...
			</div><img src="/spgame/webflow/images/Flask_Hero.png" loading="lazy" sizes="(max-width: 767px) 83vw, (max-width: 991px) 90vw, 800px" srcset="/spgame/webflow/images/Flask_Hero-p-500.png 500w, /spgame/webflow/images/Flask_Hero-p-800.png 800w, /spgame/webflow/images/Flask_Hero-p-1080.png 1080w, /spgame/webflow/images/Flask_Hero-p-1600.png 1600w, /spgame/webflow/images/Flask_Hero.png 1920w" alt="" class="banner_img">
		...
		<div class="section _2">
		  ...
		  </div><img src="/spgame/webflow/images/boan_img.png" loading="lazy" sizes="(max-width: 767px) 45vw, (max-width: 991px) 240px, 250px" srcset="/spgame/webflow/images/boan_img.png 500w, /spgame/webflow/images/boan_img.png 546w" alt="" class="main_img">
		</div>
		<div class="section _3">
		  ...
		  </div><img src="/spgame/webflow/images/Bring_your_APIs_to_MetaMask.png" loading="lazy" sizes="(max-width: 767px) 45vw, (max-width: 991px) 240px, 250px" srcset="/spgame/webflow/images/Bring_your_APIs_to_MetaMask-p-500.png 500w, /spgame/webflow/images/Bring_your_APIs_to_MetaMask-p-800.png 800w, /spgame/webflow/images/Bring_your_APIs_to_MetaMask.png 1008w" alt="" class="main_img">
		</div>
		<div class="section">
		  ...
		  <div class="intro_list">
			<div class="intro_qna" onclick="moveFaq()">
				<div class="intro_qna_title">
					<div><spring:message code="flask.banner4.btn" /></div><img src="/spgame/webflow/images/wx.png" loading="lazy" sizes="(max-width: 767px) 6vw, (max-width: 991px) 33.941162109375px, 3vw" srcset="/spgame/webflow/images/wx-p-500.png 500w, /spgame/webflow/images/wx-p-800.png 800w, /spgame/webflow/images/wx-p-1080.png 1080w, /spgame/webflow/images/wx.png 1600w" alt="" class="qna_icon">
				</div>
			</div>
		  </div>
		</div>
  ...
  <script>
	...
	$(".nav_warp").hover(
	  ...
	  function moveFaq(){
		var faqListUrl = "/spgame/user/faqList.do";
