...
<body class="home_body">
	...
	<div class="content">
    <div class="c_section">
      <h1 class="h_menu_title"><spring:message code="list.customer" /><span class="h_subtitle"><spring:message code="top.notice" /></span></h1>
      <div class="h_listblock">
        ...
        <div class="h_listarea">
         <c:forEach var="item" items="${list}">
          	<div class="h_list">
              <div class="h_list1" onclick="location.href='/landmine/user/noticeDetail.do?idx=${item.idx}'" style="cursor:pointer;">
                  ${item.title}
              </div>
					    <div class="h_list2">
		              <div class="c_date"> ${item.ndate}</div>
		          </div>
            </div>
		    </c:forEach>
        </div>
      </div>
      <form name="listForm" action="/landmine/user/noticeList.do">
