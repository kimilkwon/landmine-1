...
<div class="top">
	<div class="top_warp">
		<a href="/landmine/user/main.do" class="top_logo w-inline-block"><img
		...
		<div class="nav_area">
			<a href="#" class="nav_btn active w-button">게임</a>
			 <div class="nav_warp">
				<a href="/landmine/user/deposit.do" class="nav_btn w-button">입금</a>
				<div class="nav_toggle">
					<a href="#" class="toggle_btn w-button">입금</a>
					<a href="#" class="toggle_btn w-button">출금</a>
				</div>
			</div>
			<a href="/landmine/user/withdrawl.do" class="nav_btn w-button">출금</a>
			<!--
