				...
				<div class="app_content">
					<div class="system_warp">
						...
						<div class="system_btn_warp">
							<a href="/landmine/app_register.do" class="system_btn w-button"><spring:message code="login.txt9" /></a> 
							<a href="/landmine/app_login.do" class="system_btn _2 w-button"><spring:message code="top.login" /></a>
