				...
				<div class="app_content">
					<div class="c_content">
						<c:forEach var="item" items="${list}">
							<div class="list_warp3" onclick="location.href='/spgame/user/app_notice_detail.do?idx=${item.idx}'" style="cursor:pointer;">
								<div class="c_list_title">${item.title}</div>
								<div class="c_date"><fmt:formatDate value="${item.ndate}" pattern="yyyy-MM-dd"/></div>
							</div>
						</c:forEach>
					</div>
					<form name="listForm" action="/spgame/user/app_notice.do">
