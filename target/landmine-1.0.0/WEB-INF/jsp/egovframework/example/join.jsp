            ...
            <div class="regist_block">
             <form id="joinFrm">
              <div class="form-block w-form">
                  ...
                  <div class="input_warp">
                    <div class="input_label">비밀번호</div><input type="text" class="input1 w-input" maxlength="256" name="pw" data-name="pw" placeholder="비밀번호를 입력하세요." id="pw" required="">
                    <div class="input_notice">* Password는 6~16자리입니다.</div>
                  </div>
                  <div class="input_warp">
                    <div class="input_label">비밀번호 확인</div><input type="text" class="input1 w-input" maxlength="256" name="pwConfirm" data-name="pwConfirm" placeholder="비밀번호를 다시 한번 입력하세요." id="pwConfirm" required="">
                  ...
                  <div class="input_warp">
                    ...
                    <input type="text" class="input2 w-input" maxlength="256" name="phone" data-name="phone" placeholder="전화번호를 정확히 입력해주세요." id="phone" required=""></div>
                  </div>
                  <div class="input_warp">
                  ...
                  <div class="input_warp">
                    <div class="input_label">환전 비밀번호</div><input type="text" class="input1 w-input" maxlength="256" name="changePw" data-name="changePw" placeholder="환전시 사용할 비밀번호를 설정해주세요." id="changePw" required="">
                  </div>
                </form>
