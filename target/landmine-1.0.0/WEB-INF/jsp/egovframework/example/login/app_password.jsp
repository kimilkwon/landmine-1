				...
				<div class="app_content">
					<div class="system_warp">
						...
						<div class="password_block">
							...
							<div class="pw_block">
								<div class="pw_box">
									<input type="password" class="_pw" id="pw0" style="width:30px; text-align:center; border:none; background:transparent; outline:none;" maxlength="1" autofocus>
								</div>
								<div class="pw_box">
									<input type="password" class="_pw" id="pw1" style="width:30px; text-align:center; border:none; background:transparent; outline:none;" maxlength="1">
								</div>
								<div class="pw_box">
									<input type="password" class="_pw" id="pw2" style="width:30px; text-align:center; border:none; background:transparent; outline:none;" maxlength="1">
								</div>
								<div class="pw_box">
									<input type="password" class="_pw" id="pw3" style="width:30px; text-align:center; border:none; background:transparent; outline:none;" maxlength="1">
								</div>
								<div class="pw_box">
									<input type="password" class="_pw" id="pw4" style="width:30px; text-align:center; border:none; background:transparent; outline:none;" maxlength="1">
								</div>
								<div class="pw_box">
									<input type="password" class="_pw" id="pw5" style="width:30px; text-align:center; border:none; background:transparent; outline:none;" maxlength="1">
								</div>
								<div class="pw_box" style="display:none;">
									<input type="password" class="_pw" id="pw6"  maxlength="1">
								</div>
							</div>
...
function login(){
	$.ajax({
		...
		url : '/landmine/loginWalletPw.do',
		success:function(data){
			if(data.result == 'suc') location.href = '/landmine/user/app_mypage.do';
			else alert(data.msg);
		}
	})
}
