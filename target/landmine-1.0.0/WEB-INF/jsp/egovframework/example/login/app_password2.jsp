			...
			<div class="app_screen _2">
				...
				<div class="app_content">
					<div class="system_warp">
						<div class="system_title"><spring:message code="login.txt7" /></div>
						...
						<div class="system_btn_warp">
							<a href="#" onclick="setPw()" class="system_btn w-button"><spring:message code="login.txt8" /></a>
						</div>
					</div>
				</div>
			</div>
...
function setPw(){
	$.ajax({
		...
		url : '/landmine/setPwProcess2.do',
		success:function(data){
			if(data.result == 'suc'){
				alert(data.msg);
				location.href = '/landmine/app_walletload.do';
			}
			else $(".system_warn").text(data.txt);
		}
	})
}
